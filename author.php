...
<html lang="en" dir="ltr">
  ...
  <body>
        ...
        <?php
          ...
          while($row = mysqli_fetch_array($result)){
            ...
            <tr>
              ...
              <td>
                <form class="" action="process_delete_author.php" method="post" onsubmit="if(!confirm('Sure?')){return false;}">
    ...
    <form class="" action="<?=$form_action?>" method="post">
      ...
      <p><textarea name="profile" placeholder="profile" rows="" cols=""><?=$escaped['profile'] ?></textarea> </p>
